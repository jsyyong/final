...
class unconnectedApp extends Component {
  ...
  renderRecipePromotional = routerData => {
    let recipeId = routerData.match.params.rid;
    console.log("recipe id", recipeId);
    let recipe = this.props.recipes.find(recipe => {
      return recipe._id === recipeId;
    ...
    this.props.dispatch({ type: "set-recipedetail", recipedetail: recipe });
    this.props.dispatch({ type: "set-recipeid", recipeid: recipeId });
    return <RecipePromotional RECIPEID={recipeId} RECIPE={recipe} />;
  };
  ...
  render = () => {
    return (
      <BrowserRouter>
        ...
        <Route
          exact={true}
          path="/recipedetail/Promotional/:rid"
          render={this.renderRecipePromotional}
        />
        <Route
          exact={true}
          path="/searchResults"
